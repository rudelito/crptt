...
function generateTokenLinks(tokenaddress, chain, url) {
	...
	var tokenlinks = '<div class="tokenlinks"><div style="font-size:70%">'+tokenaddress+'</div><div style="margin-bottom: 5px;"><div>'+ swap_links + '</div><span class="lgap"></span><div>' + charts_links + '</div></div><div><div>' + tester_links + '</div><span class="lgap"></span><div>'+ scan_links +'</div></div></div>'
